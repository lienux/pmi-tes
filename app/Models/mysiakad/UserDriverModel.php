...
class UserDriverModel extends Model
{
    ...
    protected $allowedFields    = ['user_id','driver_id'];
    ...
    public function findDriverByUser()
    {
        $builder = $this->builder();
        $builder->select('driver_id');
        $builder->where('user_id', session()->get('user_id'));
        return $builder->get()->getResultArray();
    }

    public function findUserByDriver($driverID)
    {
        $builder = $this->builder();
