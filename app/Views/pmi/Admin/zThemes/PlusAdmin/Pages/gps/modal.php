                    ...
                    <div class="form-row row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group input-group-sm">
                                ...
                                <label class="small text-secondary" >ex: F 1778 RR</label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group input-group-sm">
                                ...
                                <label class="small text-secondary" >ex: 1114193260F </label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group input-group-sm">
                                ...
                                <label class="small text-secondary" >ex: 352625692756719F </label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group input-group-sm">
                                ...
                                <select class="form-select" name="simcard" id="simcard">
                                    <option value="" selected>--- Select simcard ---</option>
                                    <?php foreach ($cards as $key => $value) { ?>
                                        <option value="<?=$value['id']?>"><?=$value['gsm_no']?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
