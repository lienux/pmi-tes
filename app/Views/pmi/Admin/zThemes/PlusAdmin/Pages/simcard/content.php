            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-sm datatablez table-hover" id="stopTable">
                        ...
                        <?php $no=1; foreach ($cards as $key => $value) { ?>
                            <tr>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input checkbox_simcards" type="checkbox" id="<?=$value['id']?>">
                                    </div>
                                </td>
                                <td><?=$value['active_name']?></td>
                                <td>
                                    <div class="text-dark"><?=$value['operator_name']?></div>
                                </td>
                                <td>
                                    <div class="text-dark"><?=$value['gsm_no']?></div>
                                </td>
                                <td>
                                    <div class="text-dark"><?=$value['msidn']?></div>
                                </td>
                                <td><div class="text-dark"><?=$value['imsi_no']?></div></td>
                                <?php if(session()->get('level_id')!=3) { ?>
