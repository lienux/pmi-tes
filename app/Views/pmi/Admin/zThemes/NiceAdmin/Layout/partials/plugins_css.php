...
<link href="<?=base_url();?>/vendors/dorbitt/css/dorbitt-3.4.4.css" rel="stylesheet">

<!-- DataTables -->
<link href="<?=base_url();?>/vendors/DataTables/datatables.min.css" rel="stylesheet">

<!-- Template Main CSS File -->
<link href="<?=base_url();?>/templates/NiceAdmin/assets/css/style.css" rel="stylesheet">

<script src="<?=base_url();?>/vendors/font-awesome/5.11.2/js/all.min.js"></script>
