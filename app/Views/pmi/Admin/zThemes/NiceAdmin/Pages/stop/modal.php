                    ...
                    <div class="form-row row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group input-group-sm">
                                ...
                                <label class="small text-secondary" >ex: Halte Rawa Buaya</label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group input-group-sm">
                                ...
                                <label class="small text-secondary" >ex: -6.676346481350433 </label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group input-group-sm">
                                ...
                                <label class="small text-secondary" >ex: 106.66481839695757 </label>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group input-group-sm">
                                ...
                                <label class="small text-secondary" >ex: 5</label>
                            </div>
                        </div>
