        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-sm datatablez table-hover" id="ibuttonTable">
                        <thead>
                            <tr>
                                <th width="40">
                            ...
                            <tr>
                                <td>
                                    <div class="form-check">
                                        <input class="form-check-input checkbox_ibutton" type="checkbox" id="<?=$value['id']?>">
                                    </div>
                                </td>
                                <td>
                                    <?=($value['active']==1) ? '<span class="badge bg-success">Active</span>' : '<span class="badge bg-danger">Inactive</span>' ?>
                                </td>
                                <td>
                                    <div class="text-dark"><?=$value['ibutton_no']?></div>
                                </td>
                                <?php if(session()->get('level_id')!=3) { ?>
