                    ...
                    <div class="form-row row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group input-group-sm">
                                ...
                                <input class="form-control" type="text" name="gsm_no" id="gsm_no" />
                                <label class="small text-secondary" >ex: 085853383750 </label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group input-group-sm">
                                ...
                                <input class="form-control" type="text" name="msidn" id="msidn" />
                                <label class="small text-secondary" >ex:  </label>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group input-group-sm">
                                ...
                                <input class="form-control" type="text" name="imsi_no" id="imsi_no" />
                                <label class="small text-secondary" >ex: </label>
                            </div>
                        </div>
