					...
					<div class="col fill_height no-padding">
						...
						<div class="search_tabs_container">
							<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
								<div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="<?=base_url();?>/tijket/assets/img/suitcase.png" alt=""><span>hotels</span></div>
								<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="<?=base_url();?>/tijket/assets/img/bus.png" alt="">car rentals</div>
								<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="<?=base_url();?>/tijket/assets/img/departure.png" alt="">flights</div>
								<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="<?=base_url();?>/tijket/assets/img/island.png" alt="">trips</div>
								<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="<?=base_url();?>/tijket/assets/img/cruise.png" alt="">cruises</div>
								<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="<?=base_url();?>/tijket/assets/img/diving.png" alt="">activities</div>
							</div>		
						</div>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-1680-4">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(<?=base_url();?>/tijket/assets/img/offer_1.jpg)"></div>
								...
								<div class="offers_content">
									...
									<div class="offers_icons">
										<ul class="offers_icons_list">
											<li class="offers_icons_item"><img src="<?=base_url();?>/tijket/assets/img/post.png" alt=""></li>
											<li class="offers_icons_item"><img src="<?=base_url();?>/tijket/assets/img/compass.png" alt=""></li>
											<li class="offers_icons_item"><img src="<?=base_url();?>/tijket/assets/img/bicycle.png" alt=""></li>
											<li class="offers_icons_item"><img src="<?=base_url();?>/tijket/assets/img/sailboat.png" alt=""></li>
										</ul>
									</div>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-1680-4">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(<?=base_url();?>/tijket/assets/img/offer_5.jpg)"></div>
						...
						<div class="row">
							...
							<div class="col-lg-3 col-1680-4">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(<?=base_url();?>/tijket/assets/img/offer_6.jpg)"></div>
									<div class="offer_name"><a href="single_listing.html">grand castle</a></div>
								</div>
							</div>
							<div class="col-lg-8">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-1680-4">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(<?=base_url();?>/tijket/assets/img/offer_7.jpg)"></div>
									<div class="offer_name"><a href="single_listing.html">eurostar hotel</a></div>
								</div>
							</div>
							<div class="col-lg-8">
						...
						<div class="row">
							...
							<div class="col-lg-3 col-1680-4">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(<?=base_url();?>/tijket/assets/img/offer_8.jpg)"></div>
									<div class="offer_name"><a href="single_listing.html">grand castle</a></div>
								</div>
							</div>
							<div class="col-lg-8">
