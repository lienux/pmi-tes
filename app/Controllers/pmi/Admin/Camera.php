...
class Camera extends BaseController
{
    ...
    public function index()
    {
        ...
        foreach ($data as $keyd => $value) {
            ...
            $data[$keyd]['users_name'] = $this->user_helper->get_users($users_arr);
        }
        ...
        $data = [
            ...
            'navlink'           => 'camera',
            'page'              => 'camera/content',
            'breadcrumb'        => ['Integration','Camera'],
            'breadcrumb_active' => ['','active'],
            'table_title'       => 'List Camera',
            'appjs'             => view($admin['pages'].'camera/appjs'),
            'modal'             => view($admin['pages'].'camera/modal',['users'=>$user]),
            'data'              => [],
            'itegrationlink'    => 'show',
        ];
