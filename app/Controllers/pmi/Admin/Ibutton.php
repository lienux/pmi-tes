...
class Ibutton extends BaseController
{
    ...
    public function index()
    {
        ...
        $data = [
            ...
            'admin'             => $admin,
            'navlink'           => 'ibutton',
            'page'              => 'ibutton/content',
            'breadcrumb'        => ['Integration','iButton'],
            'breadcrumb_active' => ['','active'],
            'table_title'       => 'List iButton',
            'appjs'             => view($admin['pages'].'ibutton/appjs'),
            'modal'             => view($admin['pages'].'ibutton/modal',['users'=>$user]),
            'data'              => $data,
            'itegrationlink'    => 'show',
        ];
